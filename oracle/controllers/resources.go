...
func createAffinitySpec(inst *v1alpha1.Instance, antiAffinityNamespaces []string) {
	hasPodAffinityTermCond := inst.Spec.PodSpec.Affinity != nil
	hasPodAntiAffinityTermCond := inst.Spec.PodSpec.Affinity.PodAntiAffinity != nil
	hasPodAntiAffinityReqSchedTerm := len(inst.Spec.PodSpec.Affinity.PodAntiAffinity.RequiredDuringSchedulingIgnoredDuringExecution) > 0
	if hasPodAffinityTermCond && hasPodAntiAffinityTermCond && hasPodAntiAffinityReqSchedTerm {
	...
	} else if hasPodAffinityTermCond && hasPodAntiAffinityTermCond {
		inst.Spec.PodSpec.Affinity.PodAntiAffinity.RequiredDuringSchedulingIgnoredDuringExecution = []corev1.PodAffinityTerm{defaultPodAntiAffinity(antiAffinityNamespaces)}
	} else if hasPodAffinityTermCond {
